...
function sendMessage(){
  // Simulate telemetry.
  var temperature = Math.ceil(Math.floor(Math.random() * (31 - 30 + 1))) + 30;
...
function sendMessage2(){
  ...
  var temperature = Math.floor(Math.random() * (104 - 103 + 1)) + 103;
  var message = new Message(JSON.stringify({
    temperature: temperature,
  }));
...
intervalLoop3 = setInterval(sendMessage3, 10000);
intervalLoop4 = setInterval(sendMessage4, 10000);
